...
export const ForoNego = () => {
  ...
  const handleSubmit = (e) => {
    ...
    (async () => {
      ...
      setMensajes((prev) => [...prev, data.foroMensaje]); //!ESTO 😎🚀
      setPost(initPost);
      // console.log(data);
    })();
  };
        ...
        <div className="row">
          ...
          <div className="foroDescri text-start">
            <p className="bg-info rounded p-1 text-wrap mt-2">
              Aquí los comerciantes registrados podrán enviar propuestas de
              compra - venta, ofertas mayoristas, ofrecer servicios, fletes
              compartidos y todo lo pertinente para abaratar costos de forma
              asociativa con otros colegas comerciantes, transportistas,
              productores, intermediarios, entre otros.
            </p>
          </div>
          ...
          <div className="col-lg-8 mt-3 text-black text-start">
            <div className="bg-light border-4 border border-info rounded">
              <h5 className="mx-4 my-3">
                Supermercados APA: Hola, el 20 de diciembre realicé un pedido de
                700cajas de arroz itajai de 1kg directo de la fábrica, queda una
                vacante para 1400 cajas más, para los que quieran sumarse para
                abaratar el costo del Flete y de los precios del arroz. Teléfono
                de contactos: 123456
              </h5>
            </div>
            <br></br>
